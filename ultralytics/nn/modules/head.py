...
from .conv import Conv, Conv_Attn, GhostConv, Conv_Avg_Pooling_Attn, DS_Conv, GhostConv_Modification, CBAM, ChannelAttention_Pool
...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        self.cv2 = nn.ModuleList(
            nn.Sequential(GhostConv_Modification(x, c2, 3), GhostConv_Modification(c2, c2, 3),ChannelAttention_Pool(c2) ,nn.Conv2d(c2, 4 * self.reg_max, 1)) for x in ch
        )
