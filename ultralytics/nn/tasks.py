...
LightConv,CBAM_Module,GhostConv_Without_BN_Act,DS_Conv,DS_Conv_Attn,Conv_Avg_Pooling_Attnv2,CBAM_Conv_Avg_Pooling,Conv_sliceSamp_Attn,Conv_Spatial_Attn,Conv_Avg_Pooling_Spatial_Attn,CBAM_Conv,CBAM_Conv_Avg_Pooling,Conv_Attn,Conv_Avg_Pooling_Attn_Dropout,Conv_Prune,Conv_Mix_Pooling_Dropout_Attn,Conv_Avg_Pooling_Attn,Conv_3,Conv_Avg_Pooling,Conv_Max_Pooling,Conv_Fractional_Max_Pooling,Conv_Dropout,Conv_Fractional_Max_Pooling_Attn,Conv_SP,CBAM_Conv_Fractional_Max_Pooling,Conv_S3Pool_Attn,Avg_Pooling_Conv
)
